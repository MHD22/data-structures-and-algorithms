...
const templatingWithMustache = () => {
  ...
  characters.forEach(element => {
    const template = $('#template').html();
     html.push ( Mustache.render(template,element));
  });
  return html;
};
...
const totalCharacters = (arr) => {
  ...
  arr.forEach(element => {
    ...
    numOfChar = char[1]? numOfChar+1 : numOfChar;
    numOfChar += char[2].length;
    numOfChar++;
  });
  return numOfChar;
};
...
const houseSize = (arr) => {
  ...
  arr.forEach(element => {
    ...
    let char = Object.values(element);
    house=char[3];
    members= char[1]? members+1 : members;
    members += char[2].length;
...
const houseSurvivors = (arr) => {
  ...
  arr.forEach(element => {
    ...
    let char = Object.values(element);
    house=char[3];
    members= char[1]? deceasedSpouses.includes(char[1])? members: members+1 : members;
    members += char[2].length;
