  ...
  arr.sort((a,b)=>{
    ...
    if(a.lastName.toLowerCase() < b.lastName.toLowerCase()){
      ...
      let compare = function (a,b) {
          ...
          return a.firstName.toLowerCase() > b.firstName.toLowerCase() ? 1 : a.firstName.toLowerCase() < b.firstName.toLowerCase() ? -1 : (a.age - b.age) > 0 ? 1 :(b.age - a.age) > 0 ? -1 : 0 ;
          }
...
const sortMeetingsByDay = (arr) => {
  let days ={'Monday':1,'Tuesday':2,'Wednesday':3,'Thirsday':4,'Friday':5};
  arr.sort((a,b)=>{
  ...
  arr.sort((a,b)=>{
    ...
    if(days[a.dayOfWeek] < days[b.dayOfWeek]){
      ...
      let compare = function (a,b) {
          ...
          return (a.end - a.start) > (b.end - b.start) ? 1 : (a.end - a.start) < (b.end - b.start) ? -1 : 0 ;
          }
...
const addPearClass = () => {
  $('#fruits').children().eq(2).addClass('pear');
};
